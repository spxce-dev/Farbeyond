...
export default function Layout({ children, currentPageName }) {
  ...
  const iconColor = scrolled || !isHomePage ? 'text-neutral-700' : 'text-white';
        ...
        <div className="px-4 md:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link to={createPageUrl('Home')} className="absolute left-1/2 -translate-x-1/2">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69960d5955e8e646c7dfd706/6ba365108_IMG_7186.png"
                alt="FARBEYOND"
                className={`h-10 md:h-12 w-auto ${scrolled || !isHomePage ? '' : 'invert brightness-0 invert'}`}
              />
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-neutral-600 leading-relaxed">
                Curated luxury and streetwear for the discerning individual.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 hidden">
                {['New Arrivals', 'Sneakers', 'Clothing', 'Accessories'].map((item) => (
                  <li key={item}>
